...
import io.github.kongweiguang.voice.autoconfigure.VoiceDefaultAutoConfiguration;
...
class EouAutoConfigurationTest {
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(VoiceDefaultAutoConfiguration.class))
            .withPropertyValues(
